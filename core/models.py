...
class Order(models.Model):
    ...
    def __str__(self):
        return f"Order {self.id} for {self.meal}(x{self.quantity}) by {self.customer.full_name} worth {self.total_price} on {self.date_created}"
...
class Payment(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='payments') # User who processed the payment
